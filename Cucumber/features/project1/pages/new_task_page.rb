...
class NewTaskPage
  ...
  def initialize(driver)
    ...
    @name_field = @driver.find_element(xpath: "//input[contains(@ng-model,'taskName')]")
    @schedulable_class_dropdown = @driver.find_element(xpath: "//select//option[contains(text(),'org')]/..")
    @describtion_field = @driver.find_element(xpath: "//textarea[contains(@ng-model,'description')]")
    @start_time_field = @driver.find_element(xpath: "//input[contains(@ng-model,'startTimeVal')]")
    @repeat_interval_field = @driver.find_element(xpath: "//input[contains(@ng-model,'repeatInterval')]")
    @repeat_interval_type_dropdown = @driver.find_element(xpath: "//select//option[contains(text(),'Minutes')]/..")
    @save_btn = @driver.find_element(xpath: "//button[contains(@ng-click,'saveTaskDefinitions()')]")
  end
