...
class LogRegisterPage
  ...
  def log_user_email_field_input(user)
    log_user_email_field().send_keys user.mail
  end

  def log_user_pass_field_input(user)
    log_user_pass_field().send_keys user.pass
  end
  ...
  # -----------------------------------------------------------------------
  def reg_user_email_field_input(user)
    reg_user_email_field().send_keys user.mail
  end

  def reg_user_pass_input(user)
    reg_user_pass().send_keys user.pass
  end
  ...
  # -----------------------------------------------------------------------
  def fb_mail_field_input(user)
    $driver.find_element(id: 'email').send_keys user.mail
  end

  def fb_pass_field_input(user)
    $driver.find_element(id: 'pass').send_keys user.pass
  end
  ...
  def registration(user)
    register_tab_click()
    reg_user_email_field_input(user)
    reg_user_pass_input(user)
  ...
  def loging(user)
    login_tab_click()
    log_fb_button_click()
    fb_mail_field_input(user)
    fb_pass_field_input(user)
